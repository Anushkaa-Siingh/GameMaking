...
var sky;
var paddelImage,skyImage,playerImage,coinImage
var life =0;
var score  =0;
var coinGroup;
...
playerImageUP =loadAnimation("frame_00up.gif","frame_01up.gif","frame_02up.gif","frame_03up.gif","frame_04up.gif","frame_05up.gif","frame_06up.gif","frame_07up.gif")
...
function setup(){
 ...
 // paddel1.loadAnimation("paddel");
  paddel1.velocityX = 2;
  
   paddel2 = createSprite(297,262,30,5);
 // paddel2.loadAnimation("paddel");
  paddel2.velocityX = -2;
   paddel3 = createSprite(193,211,30,5);
 // paddel3.setAnimation('paddel');
  paddel3.velocityX = 2;
